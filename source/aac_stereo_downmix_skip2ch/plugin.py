...
class PluginStreamMapper(StreamMapper):
    ...
    def test_stream_needs_processing(self, stream_info: dict):
        # Skip processing entirely if the stream is already mono or stereo (<= 2 channels),
        # regardless of its codec. Downmixing is only needed for streams with more than
        # 2 channels (e.g. 5.1, 7.1) — there's nothing to downmix on an already-stereo stream.
